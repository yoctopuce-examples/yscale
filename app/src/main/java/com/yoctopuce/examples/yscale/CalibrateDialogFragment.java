...
public class CalibrateDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        @SuppressLint("InflateParams") final View view = inflater.inflate(R.layout.config_dialog, null);
                ...
                .setPositiveButton(R.string.calibrate_button, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        try {
                            ...
                            _listener.onDialogPositiveClick(CalibrateDialogFragment.this, ref_val, max_val);
